...
const DashboardSubHeading = styled.h2`
  font-size: 14px;
  font-weight: 500;
  font-family: poppins, sans-serif;
...
const ViewBoardContainer = styled.div`
  display: flex;
  flex-direction: row;
  height: auto;
  width: 100%;
...
const ViewBoardTextContainer = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`;

const ViewBoardText1 = styled.p`
  font-size: 14px;
  font-weight: 400;
  font-family: poppins, sans-serif;
`;

const ViewBoardText2 = styled.p`
  font-size: 14px;
  font-weight: 400;
  font-family: poppins, sans-serif;
  color: #008080;
...
const ViewBoardNumber = styled.h2`
  font-size: 32px;
  font-weight: 500;
  font-family: poppins, sans-serif;
...
const Heading = styled.h1`
  ...
  padding: 15px 0px;
  border-bottom: ${(props) =>
    props.isActive ? "3.5px solid #008080" : "3.5px solid #ACACAC"};
`;
...
const CourierDashboard = () => {
  ...
  const headings1 = ["Orders", "Shipping out for delivery ", "Delivery Status"];
  const headings2 = [
    "Order",
    "Order date",
    "Customer",
        ...
        <RightTopContainer>
          ...
          <ProfileContainer>
            <ProfileNameContainer>
              <ProfileName>Ayokunle </ProfileName>
              <Details>Software Engineer</Details>
            </ProfileNameContainer>
            <ProfileImageContainer>
              ...
              />
              <DropdownIcon htmlFor="fileInput">
                <FontAwesomeIcon icon={faCaretDown} />
              </DropdownIcon>
            </ProfileImageContainer>
          </ProfileContainer>
        </RightTopContainer>
        <DashboardSubHeading>Today&apos;s Overview</DashboardSubHeading>
        <ViewBoardContainer>
          <ViewBoard>
          ...
          <ViewBoard>
            ...
            <ViewBoardNumber>6</ViewBoardNumber>
          </ViewBoard>
        </ViewBoardContainer>
        <DashboardSubHeading>Todays&apos;s order listing</DashboardSubHeading>

        <HeadingContainer>
          {headings1.map((heading) => (
            <Heading
              key={heading}
